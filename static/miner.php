...
$protopage = array(
    ...
    'POOL+STATS' => array(
        ...
        'STATS.Times Sent=#Sent',
        'STATS.Bytes Sent=Byte Sent',
...
$kanogenext = array(
    ...
    'POOL' => array(
        ...
        'calc' => array(
            'Diff1 Shares' => 'sum',
            'Difficulty Accepted' => 'sum',
            'Difficulty Rejected' => 'sum',
            'Difficulty Stale' => 'sum',
            'Best Share' => 'max'
        ),
        'gen' => array(
            'Rej' => 'Difficulty Rejected / ' .
        ...
        switch ($name) {
            ...
            case 'Utility':
                ...
                if ($value == 0)
                    ...
                    if (
                        isset($alldata['Difficulty Accepted'])
                                                            ...
                                                            <table width=200 border=0 align=center cellpadding=5
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td height=33 align=center valign=middle>
                                                                        <input type=text name=rut size=18>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align=center valign=middle>
                                                                    ...
                                                                    <td height=33 align=center valign=middle>
                                                                        <input type=password name=roh size=18>
                                                                    </td>
                                                                </tr>
                                                                <tr valign=top>
                                                                    <td></td>
...
function checklogin()
{
    ...
    if (($rut !== null && $rut !== '') || ($roh !== null && $roh !== '')) {
        ...
        if ($rut !== null && $rut !== '' && $roh !== null && $roh !== '') {
            if (
                isset($userlist['sys']) && isset($userlist['sys'][$rut])
            ...
            if (
                isset($userlist['usr']) && isset($userlist['usr'][$rut])
...
function display()
{
    ...
    if ($allowcustompages === true) {
        ...
        if ($pagesonly === true) {
            if ($pg !== null && $pg !== '') {
                if (
                    $userlist !== null && isset($userlist['def'])
